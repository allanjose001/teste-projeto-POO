package com.api.testeagenda.controllers;
...
import com.api.testeagenda.dtos.AgendaFacilDto;
import com.api.testeagenda.models.AgendaFacilModelo;
import com.api.testeagenda.services.AgendaFacilService;
...
public class AgendaFacilController {
	...
	public ResponseEntity<Object> saveAgendaFacil(@RequestBody @Valid AgendaFacilDto agendaFacilDto) {
		if(agendaFacilService.existsByCodigoUBS(agendaFacilDto.getCodigoUBS())) {
			return ResponseEntity.status(HttpStatus.CONFLICT).body("Conflito: Codigo de UBS em uso");
		}
